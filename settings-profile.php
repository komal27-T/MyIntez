                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-xl-4">
                                <div class="page-title-content">
                                    ...
                                    <p class="mb-2">Welcome to Intez Profile page</p>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="col-xxl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" name="myform" action="Sprofile.php" enctype="multipart/form-data" class="personal_validate" novalidate="novalidate">
...
?-->
                        ...
                        <?php
                        include 'connect.php';
                        $query = "SELECT id, name, email, password FROM signup WHERE id = '$id'" ;
                        ...
                        echo  $row['password'] ; ?>"
                                ...
                                <?php } ?>
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary pl-5 pr-5" name="sbtn">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
