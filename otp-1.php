                    ...
                    <div class="auth-form card">
                        <div class="card-body">
                            <p class="text-center mb-3">Enter the verification code generated by your phone ending
                                in +xxx xxxxxxxx60.</p>
                            <form action="https://intez-html.vercel.app/otp-2.php" class="row g-3">
                                <div class="col-12">
                                ...
                                <div class="alert-text">
                                    <small>Security is critical in Xtrader. to help keep your account safe, we'll text
                                        you
                            ...
                            <div class="new-account mt-3">
                                <p>Don't get code? <a class="text-primary" href="otp-1.php">Resend</a></p>
                            </div>
                        </div>
                    </div>
                </div>
